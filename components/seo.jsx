...
const Seo = ({ title }) => {
  return (
    <Head>
      ...
      <link rel="icon" href="https://media-exp1.licdn.com/dms/image/C4D03AQEGLgrAjJAXxA/profile-displayphoto-shrink_800_800/0/1662497414233?e=1668643200&amp;v=beta&amp;t=CZ10RzvMqinH_Rb8iRbdP61jGzzFTyStisCSQyi7Wuo" />
      <link
        rel="shortcut icon"
      ...
      <meta
        name="keywords"
        content="Harshvardhan Singh, Blogs, Musing"
      />
    </Head>
  );
};
